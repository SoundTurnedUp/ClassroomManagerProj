...
namespace ClassroomManagerProj
{
    public partial class TeachersMenu : Form
    {
        ...
        private void TeachersListView_ItemActivate(object sender, EventArgs e)
        {
            ...
            {
                Teacher selectedTeacher = (Teacher)listViewTeachers.SelectedItems[0].Tag;

                MessageBox.Show($"Subjects taught by {selectedTeacher.GetName()}:\n{selectedTeacher.GetSubject()}", "Subjects", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
